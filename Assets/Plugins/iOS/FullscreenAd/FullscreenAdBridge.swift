...
final class FullscreenAdBridge<Ad: PresentingAd> {
    var canShowAd: Bool {
    ...
    private var loadedAd: Ad?
    
    private let adPresenter: FullscreenAdPresenter
...
extension FullscreenAdBridge: AdRequestProtocol {
