...
1.2 To import the BidMachine Unity plugin, double-click on the BidMachine-Unity-Plugin-1.2.1-27.03.2023.unitypackage , or go to Assets → Import Package → Custom Package . Keep all the files in the Importing Package window selected, and click Import .
